...
export default function MyRequestsPage() {
  ...
  const fetchRequests = async () => {
    try {
      ...
      // Filter out reserved ones because they move to "Availed Services"
      setRequests(res.data.data.filter((r: any) => !r.isReserved));
    } catch (err) {
      console.error(err);
    } finally {
      setLoading(false);
  ...
  return (
    <DashboardLayout
      title="My Requests"
      subtitle="Availer Dashboard • Manage your posted jobs."
    >
