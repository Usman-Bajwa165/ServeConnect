    ...
    <DashboardLayout>
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
           ...
           <p className="mt-2 text-gray-600">Fill out the details below to list your service. The AI will assist with the description!</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 pt-10 relative overflow-hidden animate-slide-up">
          ...
          <form className="space-y-6 relative z-10" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                 ...
                 <p className="text-xs text-gray-500 mt-1 flex items-center gap-1">
                    ...
                    AI will auto-generate a description when you finish entering the title.
                 </p>
              </div>
              ...
              <div className="md:col-span-2">
                 ...
                 <p className="text-xs text-gray-500 mt-1 flex items-center gap-1">
                    <svg className="w-3 h-3 text-brand-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                    Press Tab while typing to complete your sentences with AI.
                 </p>
              </div>
            ...
            <div className="pt-6 mt-6 border-t border-gray-100 flex justify-end gap-3">
              ...
              <Button type="submit" isLoading={loading} size="lg" className="px-8 shadow-md">Publish Service</Button>
            </div>
          </form>
        </div>
      </div>
