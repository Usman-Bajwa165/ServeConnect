...
export default function EditServicePage() {
  ...
  const handleDescriptionBlur = async () => {
    ...
    try {
      ...
      if (res.data?.data?.suggestion) {
        setFormData((prev) => ({
          ...prev,
          description: res.data.data.suggestion,
        }));
      }
    } catch (err) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    startGlobalLoading();
    try {
      await axios.patch(`/services/${serviceId}`, {
        ...formData,
  ...
  return (
    ...
    >
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 pt-12 relative overflow-hidden animate-slide-up max-h-[90vh] overflow-y-auto">
          ...
          {fetching ? (
            <div className="py-20 flex justify-center text-brand-500 animate-pulse">
            ...
            <form className="space-y-6 relative z-10" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-xs text-gray-500 mt-1 flex items-center gap-1">
                    ...
                    AI refines your description automatically on exit.
                  </p>
                </div>
              ...
              <div className="pt-6 mt-6 border-t border-gray-100 flex justify-end gap-3">
                ...
                <Button type="submit" isLoading={loading} size="lg" className="px-8 shadow-md">
                  Update Service
                </Button>
              </div>
            </form>
